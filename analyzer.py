...
_TARGET = (
    r"(?:you|u|y'?all|him|her|them|your\s+family|ur\s+family|"
    r"your\s+loved\s+ones|everyone\s+you\s+love|your\s+kids|"
    r"your\s+children|your\s+parents|your\s+whole\s+family)"
)
